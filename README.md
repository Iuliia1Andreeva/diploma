# Корректировка результатов квантово-механических вычислений ширины запрещенной зоны веществ на основе использования экспериментальных данных и машинного обучения
